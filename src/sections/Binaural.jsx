...
import { Headphones, Sparkles, AlertTriangle, Play, Pause } from 'lucide-react';
...
const BinauralTrackCard = ({ track, isActive, onToggle, onEnded }) => {
...
const Binaural = () => {
  ...
  const handleToggleTrack = (trackId, audioElement) => {
  ...
  const handleTrackEnded = (trackId) => {
