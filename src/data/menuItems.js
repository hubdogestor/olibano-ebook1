import { Leaf, Info, Droplets, Wind, Brain, Gem, Sun, Headphones, Calendar, Heart } from 'lucide-react';
...
export const getSectionIndex = (sectionId) => menuItems.findIndex((item) => item.id === sectionId);
